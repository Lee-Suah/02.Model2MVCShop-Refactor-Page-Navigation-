...
<%
	Product vo1=(Product)request.getAttribute("product");
   System.out.println("상품번호 : " +vo1.getProdNo());
...
<input type="hidden" name="prodNo" value=<%=vo1.getProdNo() %>  />
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo1.getProdName() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo1.getProdDetail() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo1.getManuDate() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo1.getPrice() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=vo1.getRegDate() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
